...
import Explore from './components/Explore.js/Explore'
...
function App() {
    ...
    return (
        <BrowserRouter>
            <NavBar isVerified={user.is_verified} setSearchText={setSearchText} serachText={serachText} />
            <Container maxW={'container.lg'} px={[3, 3, 6]} mt={2}>
                <Flex h='100vh' pb={20}>
                    <Routes>
                        ...
                        <Route path='/explore' element={<Explore regions={regions} text={serachText} categories={categories} />} />
                    </Routes>
                </Flex>
            </Container>
            <Footer />
